...
# --- 레버리지 & 마틴게일 ---
# 사이징 최적화 결과 (7년 검증, 비율 기반):
#   총노출 45% → MDD 48.7%  PF 2.056  총회수 $7,006   (리스크 조정 최적)
#   총노출 65% → MDD 59.7%  PF 1.921  총회수 $11,573  ★ (퀀텀 점프 채택)
#   총노출 85% → MDD 60.4%  PF 1.997  총회수 $17,113  (최대 수익, MDD↑)
#
# 비율 산출: x × (1 + 2.5 + 6.25 + 15.625 + 39.0625) = 0.65
#   → x = 0.65 / 64.4375 ≈ 0.01009  (×2.5 배수 유지)
LEVERAGE = 20
